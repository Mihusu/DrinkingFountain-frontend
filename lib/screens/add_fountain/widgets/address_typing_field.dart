...
class AddressSearchWidget extends StatelessWidget {
  ...
  AddressSearchWidget({super.key, required this.onLocationSelected}) {
  ...
  Future<void> _handlePress(BuildContext context) async {
    ...
    if (prediction != null) {
      ...
      final description =
          detail.result.formattedAddress; // Get the human-readable address
      if (lat != null && lng != null) {
        onLocationSelected(
            description!, lat, lng); // Pass both the address and coordinates
      }
    }
  }
